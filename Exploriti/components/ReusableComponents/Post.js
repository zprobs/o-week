...
const Post = ({item, index}) => {
  ...
  return (
    <View style={{...styles.container, ...containerBorderRadius }}>
      ...
      <Text numberOfLines={4} style={styles.body}>Contrary to popoular belief  \I can type treallt reallt fast. so fast in fact that it exceeds my typing ability for handrwriting. Zoom zoom little one.</Text>
