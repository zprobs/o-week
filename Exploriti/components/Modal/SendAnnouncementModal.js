...
const SendAnnouncementModal = React.forwardRef(
  /**
   * used by admins to send global notifications
  ...
  ({ onClose }, ref) => {
    ...
    const [sendNotifications, { error: notifError }] = useMutation(
      SEND_NOTIFICATIONS,
    );
      ...
      <Modalize
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.info}>
            Please use for important Information only. Users will already
            receive notifications for new events and updates to event times.
          </Text>
          <FormInput
            value={message}
            ...
            placeholder={
              'example: The winner of the orientation competition is group A!'
            }
            ref={null}
            autoCapitalize
          />
